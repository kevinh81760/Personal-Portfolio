            ...
            <div className="ml-25 relative bottom-80">
                ...
                <div className="flex space-x-6">
                    ...
                    <div className="f">
                        ...
                        <p1 className="relative top-4 text-[23px] font-semibold">A CSGO trading chatbot deployed on <br/> AWS EC2. It scrapes the top five trading<br/> sites in real time and uses RAG to generate<br/> market-based responses. Built with MERN <br/>for fast and dynamic interaction.
